...
public interface IBase extends IHwInterface {
    ...
    public static abstract class Stub extends HwBinder implements IBase {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, ReqMsg.request_stop_local_ring_back_tone, ReqMsg.request_xdm_modify_contact, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
