    ...
    public final int zzb(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i7 < length) {
            ...
            if (charAt2 < 128 && i8 < i6) {
                ...
                int i10 = i8 + 1;
                bArr[i8] = (byte) ((charAt2 >>> 12) | NSDSNamespaces.NSDSHttpResponseCode.TEMPORARILY_UNAVAILABLE);
                int i11 = i10 + 1;
                ...
                if (i12 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                        ...
                        int i13 = i8 + 1;
                        bArr[i8] = (byte) ((codePoint >>> 18) | Id.REQUEST_STOP_RECORD);
                        int i14 = i13 + 1;
