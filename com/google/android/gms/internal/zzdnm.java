...
public class zzdnm {
    ...
    public static final AtomicBoolean zzlxi = new AtomicBoolean();
    ...
    private static <T> T zza(java.util.HashMap<java.lang.String, T> r2, java.lang.String r3, T r4) {
        /*
            java.lang.Class<com.google.android.gms.internal.zzdnm> r0 = com.google.android.gms.internal.zzdnm.class
            monitor-enter(r0)
    ...
    public static java.lang.String zza(android.content.ContentResolver r13, java.lang.String r14, java.lang.String r15) {
        /*
            java.lang.Class<com.google.android.gms.internal.zzdnm> r15 = com.google.android.gms.internal.zzdnm.class
            monitor-enter(r15)
            zza(r13)     // Catch:{ all -> 0x00a2 }
            java.lang.Object r0 = zzlxo     // Catch:{ all -> 0x00a2 }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzlxj     // Catch:{ all -> 0x00a2 }
            boolean r1 = r1.containsKey(r14)     // Catch:{ all -> 0x00a2 }
            r2 = 0
            if (r1 == 0) goto L_0x001e
            java.util.HashMap<java.lang.String, java.lang.String> r13 = zzlxj     // Catch:{ all -> 0x00a2 }
        ...
        L_0x001c:
            ...
            return r2
        L_0x001e:
            java.lang.String[] r1 = zzlxq     // Catch:{ all -> 0x00a2 }
        ...
        L_0x0023:
            ...
            boolean r0 = zzlxp     // Catch:{ all -> 0x00a2 }
            if (r0 == 0) goto L_0x003a
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzlxj     // Catch:{ all -> 0x00a2 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00a2 }
            if (r0 == 0) goto L_0x005c
        L_0x003a:
            java.lang.String[] r0 = zzlxq     // Catch:{ all -> 0x00a2 }
            java.util.HashMap<java.lang.String, java.lang.String> r1 = zzlxj     // Catch:{ all -> 0x00a2 }
            java.util.Map r13 = zza(r13, r0)     // Catch:{ all -> 0x00a2 }
            r1.putAll(r13)     // Catch:{ all -> 0x00a2 }
            zzlxp = r6     // Catch:{ all -> 0x00a2 }
            java.util.HashMap<java.lang.String, java.lang.String> r13 = zzlxj     // Catch:{ all -> 0x00a2 }
    ...
    private static Map<String, String> zza(ContentResolver contentResolver, String... strArr) {
        Cursor query = contentResolver.query(zzlxf, (String[]) null, (String) null, strArr, (String) null);
    ...
    private static void zza(ContentResolver contentResolver) {
        if (zzlxj == null) {
            ...
            zzlxo = new Object();
            zzlxp = false;
            contentResolver.registerContentObserver(CONTENT_URI, true, new zzdnn((Handler) null));
