...
final class zzaj implements ServiceConnection {
    ...
    public final void zzgr(String str) {
        this.mState = 3;
        boolean zza = this.zzghd.zzggx.zza(this.zzghd.mApplicationContext, str, this.zzghc.zzcq(this.zzghd.mApplicationContext), this, this.zzghc.zzamu());
        this.zzghb = zza;
        if (zza) {
