...
public interface IProfileChangedCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IProfileChangedCallback {
        private static final String DESCRIPTOR = "com.att.iqi.IProfileChangedCallback";
        static final int TRANSACTION_onProfileChanged = 1;

        private static class Proxy implements IProfileChangedCallback {
