...
public interface IServiceStateChangeCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IServiceStateChangeCallback {
        private static final String DESCRIPTOR = "com.att.iqi.IServiceStateChangeCallback";
        static final int TRANSACTION_onServiceChange = 1;

        private static class Proxy implements IServiceStateChangeCallback {
