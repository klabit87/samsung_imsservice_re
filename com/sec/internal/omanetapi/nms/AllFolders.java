...
public class AllFolders extends BaseNMSRequest {
    ...
    public AllFolders(String serverRoot, String apiVersion, String storeName, String boxId) {
        super(serverRoot, apiVersion, storeName, boxId);
        buildAPISpecificURLFromBase();
    }

    public void initPostRequest(Folder folder, boolean isJson) {
        ...
        if (isJson) {
            ...
            body = new HttpPostBody(new Gson().toJson(folder));
        }
        if (body != null) {
            setPostBody(body);
        }
