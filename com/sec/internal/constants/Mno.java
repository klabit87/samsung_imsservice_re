...
public class Mno {
    ...
    public static Mno H3G_DK = new Mno("3_DK", "HTD,NEE", Region.EUROPE, Country.DENMARK);
    ...
    public static Mno TELENOR_DK = new Mno("Telenor_DK", "", Region.EUROPE, Country.DENMARK);
    ...
    public static Mno TELIA_NORWAY = new Mno("Telia_NO", "NEE", Region.EUROPE, Country.NORWAY);
    ...
    public enum Country {
        ...
        private Country(Region region2, String countryIso2) {
            this.region = region2;
    ...
    public boolean isVodafone() {
        return this == VODAFONE_UK || this == VODAFONE || this == VODAFONE_SPAIN || this == VODAFONE_ITALY || this == VODAFONE_NETHERLAND || this == VODAFONE_HUNGARY || this == VODAFONE_IRELAND || this == VODACOM_SOUTHAFRICA || this == VODAFONE_GREECE || this == VODAFONE_ROMANIA || this == VODAFONE_PORTUGAL || this == VODAFONE_CROATIA || this == VODAFONE_TURKEY || this == VODAFONE_ALBANIA || this == VODAFONE_CZ;
    }
    ...
    public static String convertContryCode(String key) {
        ...
        if (key.lastIndexOf(":") > 0) {
            String countryCode = key.substring(start, key.lastIndexOf(":"));
            return key.replaceFirst(countryCode + ":", countryCode.toUpperCase() + ":");
        }
        String countryCode2 = key.substring(start, end);
        return key.replaceFirst(countryCode2 + "$", countryCode2.toUpperCase());
    }
