...
public final class NotifyVideoEventData extends Table {
    public static NotifyVideoEventData getRootAsNotifyVideoEventData(ByteBuffer _bb) {
        return getRootAsNotifyVideoEventData(_bb, new NotifyVideoEventData());
    }

    public static NotifyVideoEventData getRootAsNotifyVideoEventData(ByteBuffer _bb, NotifyVideoEventData obj) {
    ...
    public NotifyVideoEventData __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static int createNotifyVideoEventData(FlatBufferBuilder builder, long phone_id, long session, long event, long arg1, long arg2) {
        ...
        return endNotifyVideoEventData(builder);
    }

    public static void startNotifyVideoEventData(FlatBufferBuilder builder) {
        builder.startObject(5);
    }
    ...
    public static int endNotifyVideoEventData(FlatBufferBuilder builder) {
