...
public class FaxSyncHandler extends BaseSyncHandler {
    public static final String TAG = FaxSyncHandler.class.getSimpleName();

    public FaxSyncHandler(Looper looper, Context context, INetAPIEventListener APIEventListener, IUIEventCallback uicallback, String line, SyncMsgType type, ICloudMessageManagerHelper iCloudMessageManagerHelper) {
    ...
    public void setWorkingQueue(BufferDBChangeParam param, BaseSyncHandler.SyncOperation syncParam) {
        ...
        String str = TAG;
        Log.d(str, "setWorkingQueue :: " + param + " setMsgDownloadQueue size : " + this.mWorkingDownloadQueue.size());
    }
