...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder cacheControl(CacheControl cacheControl) {
            ...
            if (value.isEmpty()) {
                return removeHeader(HttpController.HEADER_CACHE_CONTROL);
            }
            return header(HttpController.HEADER_CACHE_CONTROL, value);
        }
        ...
        public Builder delete(RequestBody body2) {
            return method(HttpController.METHOD_DELETE, body2);
        }
