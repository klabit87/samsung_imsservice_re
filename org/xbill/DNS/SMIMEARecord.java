...
public class SMIMEARecord extends Record {
    ...
    public SMIMEARecord(Name name, int dclass, long ttl, int certificateUsage2, int selector2, int matchingType2, byte[] certificateAssociationData2) {
        super(name, 53, dclass, ttl);
